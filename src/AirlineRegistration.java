...
public class AirlineRegistration {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, " Here is your boarding pass information: " + " First Name: " + firstname + " Last Name: " + lastname + " Destination: " + destination + " Birthday: " + birthday + " Gender: " + gender);
	}
}
