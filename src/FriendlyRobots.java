...
public class FriendlyRobots {
	...
	public FriendlyRobots() {
		...
		for(int j = 0; j<200; j++){
			...
			if (foundFriend(gurley, gayta) == true) 
			{
	...
	int x =	JOptionPane.showConfirmDialog(null, "Do you want to play again??");
	if (x == 1){
		break;
	}
		}
